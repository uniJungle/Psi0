...
from dreamzero.groot.vla.common.utils import get_all_frames, get_frames_by_timestamps
from dreamzero.groot.vla.data.conversion.gr1.get_initial_actions import load_initial_actions
...
METADATA_DIR = Path(importlib.import_module("dreamzero.groot.vla.data").__file__).parent / "metadata"  # type: ignore
...
class LeRobotSingleDataset(Dataset):
    ...
    def __init__(
        ...
        Args:
            ...
            allow_padding_at_end (bool): End-of-episode padding (psi0_simple-only). Set by the parent
        ...
        if "action.task_progress" in self._modality_keys["action"]:
            from dreamzero.groot.vla.data.schema import StateActionMetadata
